...
export default function LandingPage() {
  return (
    <>
      <div className="flex flex-col scroll-smooth items-center w-full justify-center py-6 md:py-12 gap-12 md:gap-20 lg:gap-28 overflow-x-clip md:overflow-x-auto">
        <Hero />
        <TakePayments />
        <KeyAdvantages />
