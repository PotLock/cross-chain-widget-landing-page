    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <div className="relative size-4 shrink-0 translate-y-0.5">
          <Plus
            strokeWidth={1}
            className="text-muted-foreground pointer-events-none absolute inset-0 size-6 transition-all duration-200 group-data-[state=open]:opacity-0 group-data-[state=open]:rotate-65"
          />
          <Minus
            strokeWidth={1}
            className="text-muted-foreground pointer-events-none absolute inset-0 size-6 opacity-0 transition-all duration-200 group-data-[state=open]:opacity-100"
          />
        </div>
      </AccordionPrimitive.Trigger>
